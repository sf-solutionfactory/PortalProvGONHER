...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:RadioButtonList ID="rdbPantalla" CssClass="radioButtonList" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdbPantalla_SelectedIndexChanged" AutoPostBack="True">
        <asp:ListItem Value="1">MIR7</asp:ListItem>
        <asp:ListItem Value="32">FV60</asp:ListItem>
    </asp:RadioButtonList>
    <br />
    ...
    <asp:Panel ID="pnlNuevo" runat="server">
        ...
        <table class="tblFm2">
            <tr>
                <td><strong>Crear nuevos grupos de validación</strong></td>
            </tr>
        </table>
        <br />
        <table class="tblFm">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:proveedores2ConnectionString %>" SelectCommand="consultarGrupoValidacionesXML" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="" Name="idPants" SessionField="idPants" Type="Int32" />
            </SelectParameters>  
        </asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="srcProveedoresNoSeleccionados" runat="server" ConnectionString="<%$ ConnectionStrings:proveedores2ConnectionString %>" SelectCommand="consultarProvNoSelToGrpVal" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="" Name="idPants" SessionField="idPants" Type="Int32" />
            </SelectParameters> 
        </asp:SqlDataSource>
