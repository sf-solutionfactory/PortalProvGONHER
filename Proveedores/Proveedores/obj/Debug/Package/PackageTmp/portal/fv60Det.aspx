<%@ Page Title="" Language="C#" MasterPageFile="~/pagMaestra/MtrProveedor.Master" AutoEventWireup="true" CodeBehind="fv60Det.aspx.cs" Inherits="Proveedores.portal.fv60Det" EnableEventValidation="false" %>
        ...
        <div id="pop-up">
                <div id="msgWrap" style="width: 840px;">
                    ...
                    <div id="divConsola" style="width: 340px;height: 277px;border: 3px solid #0B2161; background:#CCCCCC;margin-left:510px;padding:10px;color:#333333;">
                        ...
                        <asp:Label ID="lblConsola" runat="server" CssClass="error" Font-Size="Medium"></asp:Label>
                        <br />
                        <asp:Label ID="lblIdEstatus" runat="server" CssClass="lblIdEstatus" Visible="False"></asp:Label>

                    </div>
                </div>
                <a href="factFV60.aspx"><div class="ico-cerrar">VOLVER</div></a>
            </div>
        </center>
