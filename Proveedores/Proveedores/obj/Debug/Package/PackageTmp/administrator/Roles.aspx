    ...
    <asp:Panel ID="Panel1" runat="server">
        <table class="tblFm">
            ...
            <tr>
                ...
                <td>
                    <table>
                    <tr><td><asp:CheckBox ID="chkFacturasMIR7" runat="server" Text="Facturas MIR7" CssClass="chk" name="chkVerificar"/></td></tr>
                    <tr><td><asp:CheckBox ID="chkFacturasFV60" runat="server" Text="Facturas FV60" CssClass="chk" name="chkVerificar"/></td></tr>
